...
<template>
  <div id="facility">
    <div class="mx-auto flex h-fit max-w-[21rem] flex-col sm:max-w-[44rem] lg:max-w-[72rem]">
      ...
      <div class="flex flex-col lg:flex-row gap-12 pt-6 lg:pt-12">
        <div class="flex flex-col items-center">
          <img class="w-36" :src="facilityIcons[0]" alt="" />
          <div class="pt-6 lg:p-4 text-center md:p-8">
        ...
        <div class="flex flex-col items-center">
          <img class="w-36" :src="facilityIcons[1]" alt="" />
          <div class="pt-6 lg:p-4 text-center md:p-8">
            <h3 class="font-serif text-2xl font-bold text-gray-800 dark:text-white">
              Fasilitas 2
            </h3>
        ...
        <div class="flex flex-col items-center">
          <img class="w-36" :src="facilityIcons[2]" alt="" />
          <div class="pt-6 lg:p-4 text-center md:p-8">
            <h3 class="font-serif text-2xl font-bold text-gray-800 dark:text-white">
              Fasilitas 3
            </h3>
        ...
        <div class="flex flex-col items-center">
          <img class="w-36" :src="facilityIcons[3]" alt="" />
          <div class="pt-6 lg:p-4 text-center md:p-8">
            <h3 class="font-serif text-2xl font-bold text-gray-800 dark:text-white">
              Fasilitas 4
            </h3>
