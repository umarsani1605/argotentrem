...
<template>
  <!-- Fasilitas -->
  <div class="h-[600px]">
    <div class="h-full max-w-[72rem] mx-auto px-4 flex flex-col justify-center my-4">
      <!-- Title -->
      ...
      <!-- Cards -->
      <div class="flex py-12 gap-5">
        <div class="flex flex-col items-center">
          <img :src="facilityIcons[0]" alt="">
